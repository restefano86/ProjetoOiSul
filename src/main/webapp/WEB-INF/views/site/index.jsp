		...
		<div id="site">
			<%@include file="cabecalho.jsp" %>
			 <div id="conteudo">
				<div id="nav"></div>
				<div id="slides">
					<img alt="slide1" id="slide1" src="/ProjetoOiSul/resources/images/banner1.jpg" width="948px" height="245px">
					<img alt="slide2" id="slide2" src="/ProjetoOiSul/resources/images/banner2.jpg" width="948px" height="245px">
				</div>
			 <div id="divisao"></div>
			 	...
			 	<table id="tabelaOfertasIndex">
			 	
			 		<tr>
			 			<td>
			 				<img alt="oferta1" src="/ProjetoOiSul/resources/images/telefoniaMovel.png">
			 			</td>
			 			<td>
			 				<img alt="oferta1" src="/ProjetoOiSul/resources/images/telefoniaFixa.png">
			 			</td>
			 		</tr>
